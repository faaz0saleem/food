...
CREATE TABLE IF NOT EXISTS users (
  ...
  ai_spend_usd DECIMAL(10,5) NOT NULL DEFAULT 0,
  ai_spend_month DECIMAL(10,5) NOT NULL DEFAULT 0,
  ai_spend_month_key VARCHAR(7) NULL,
